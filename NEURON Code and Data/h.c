...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 11, 1);
 	...
 	ivoc_help("help ?1 hd C:/Users/tesler/Dropbox Data/PhD/MATLAB/Cellular Composite Model/Simulations/Spatial Shaping/Data/h.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "I-h channel from Magee 1998";
